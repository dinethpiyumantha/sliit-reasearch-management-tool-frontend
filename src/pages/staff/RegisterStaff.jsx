         ...
         <h2 className="mb-4">Register Staff</h2>
          <form onSubmit={submit} style={{width: '50rem'}}>
              ...
              <div class="form-check">
                    ...
                    <label className="form-check-label" for="check1">Artificial inteligence</label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="Machine Learning" id="check2"/>
                    <label className="form-check-label" for="check2">Machine Learning</label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="image Processing" id="check3"/>
                    <label className="form-check-label" for="check3">image Processing</label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="E-Governance" id="check4"/>
                    <label className="form-check-label" for="check4">E-Governance</label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="Data Science" id="check5"/>
                    <label className="form-check-label" for="check5">Data Science</label>
              </div>
              </div>
              ...
              <div class="form-check">
                    ...
                    <label className="form-check-label" for="check6">Human Computer Interaction </label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="Cloud Computing" id="check7" />
                    <label className="form-check-label" for="check7">Cloud Computing</label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="Cyber Security" id="check8" />
                    <label className="form-check-label" for="check8">Cyber Security</label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="Robotics" id="check9" />
                    <label className="form-check-label" for="check9">Robotics</label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="Internet Of Things" id="check10"/>
                    <label className="form-check-label" for="check10">Internet Of Things</label>
              </div>
              </div>
              ...
              <div class="form-check">
                    ...
                    <label className="form-check-label" for="check11">Embedded Systems </label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="Soft Computing" id="check12" />
                    <label className="form-check-label" for="check12">Soft Computing</label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="Big Data" id="check13" />
                    <label className="form-check-label" for="check13">Big Data</label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="Assitive Technology" id="check14" />
                    <label className="form-check-label" for="check14">Assitive Technology</label>
              </div>
              <div class="form-check">
                    <input className="form-check-input" type="checkbox" value="Computer Networks" id="check15"/>
                    <label className="form-check-label" for="check15">Computer Networks</label>
              </div>
              </div>
