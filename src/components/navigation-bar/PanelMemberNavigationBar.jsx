...
export default function PanelMemberNavigationBar() {
                ...
                <div>
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0 gap-3">
                            ...
                            <li className={(path == '/panelmember/viewtopics') ? 'nav-item nav-active pb-1' : 'nav-item pb-1'}>
                                <Link to="/panelmember/viewtopics" className={(path == '/panelmember/viewtopics') ? 'btn nav-item-btn-active' : 'btn'}>
                                <i class="fas fa-check-circle"></i>
                                <span className="ms-1">Topic Evaluate</span>
                            </Link>
                            </li>
                            <li className={(path == '/panelmember/evaluate/presentation') ? 'nav-item nav-active pb-1' : 'nav-item pb-1'}>
                                <Link to="/panelmember/evaluate/presentation" className={(path == '/panelmember/evaluate/presentation') ? 'btn nav-item-btn-active' : 'btn'}>
                                <i class="fas fa-file-signature"></i>
                                <span className="ms-1">Presentation Evaluation</span>
                            </Link>
                            </li>
